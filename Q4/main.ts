...
let personName:string ="Sir Syed Ahmed Khan said";
console.log(`"${personName}, "Ignorance is mother of poverty." `);
...
let message:string = "No nation can rise to the glory ,unless your women are side by side with you.";
